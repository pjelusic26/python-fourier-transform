...
img = cv2.imread('siqijor_noise_3.jpg', 0)                                          #Reads the original image
...
cv2.imwrite('siqijor_magnitude_3.jpg', magnitude_spectrum)                          #Saves the magnitude spectrum image as a file (needed for Photoshop to create image mask)

img_mask = cv2.imread('noise_mask_3.bmp', 0)                                        #Reads the mask image (generated in Photoshop)
